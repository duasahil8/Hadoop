...
public class SubjectAverageEnrollment {
	...
	extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context
			...
			if (lineSplit.length <= 11) {
				...
				if(Integer.parseInt(enrollment) > 20){
					IntWritable v = new IntWritable(Integer.parseInt(enrollment));

					String keyWord = department + "_" + courseName;
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(SubjectAverageEnrollment.class);
