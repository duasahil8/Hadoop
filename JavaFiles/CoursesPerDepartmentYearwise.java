...
import sample.HighLowDepartment.IntSumReducer;
import sample.HighLowDepartment.TokenizerMapper;

public class CoursesPerDepartmentYearwise {
		...
		public void map(Object key, Text value, Context context
			...
			if (lineSplit.length <= 11) {
				...
				if(enrollment >0){
					...
					String keyWord = department + "_"  + sem[1] ;
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CoursesPerDepartmentYearwise.class);
