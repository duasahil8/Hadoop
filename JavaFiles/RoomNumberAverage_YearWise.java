...
import sample.TimeTrends.IntSumReducer;
import sample.TimeTrends.TokenizerMapper;

public class RoomNumberAverage_YearWise {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(RoomNumberAverage_YearWise.class);
